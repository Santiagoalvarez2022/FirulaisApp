...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'shttps://firulais-gd1y2al7q-santiagoalvarez2022.vercel.app/'); // update to match the domain you will make the request from
