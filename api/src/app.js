...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://firulais-1y8jbdr7w-santiagoalvarez2022.vercel.app/'); // update to match the domain you will make the request from
