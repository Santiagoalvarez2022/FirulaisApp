...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'santiagoalvarez-bfphrs4s2-santiagoalvarez2022.vercel.app'); // update to match the domain you will make the request from
